...
#     n = int(input("Enter till which number u want: "))
...
#     print(f"The sum of the digits in {number} is {sum_result}")
...
def product_of_digits():
    number = input("Enter a number to find the product of its digits: ")
    product_result = 1

    for digit in number:
        product_result *= int(digit)

    print(f"The product of the digits in {number} is {product_result}")
product_of_digits()