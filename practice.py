...
# # # print(a % b) # modulus (coef div)

# # # print(a ** b)/"*" - represents power

# # # print(-a) # unary minus 

# # # print(a) 3 unary plus
...
coordinates = (3,2,4,2,4,3)

position = coordinates.index(4)
position = coordinates.count(1)
